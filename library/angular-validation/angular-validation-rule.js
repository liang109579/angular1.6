        ...
        .config(['$validationProvider', function($validationProvider) {
            ...
            var expression = {
                ...
                telephone: function(value) {
                    if (!value) return true;
                    var TELPHONE_RETEXP = /^((\d{3}-\d{8}|\d{4}-\d{7,8})|(1[3|5|7|8][0-9]{9}))$/;
                ...
                date: function(value) {
                    ...
                    if (!value) return true;
                    var NEWFOLDER_RETEXP = /([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8])))/;
                    return NEWFOLDER_RETEXP.test(value);
                },
            };
